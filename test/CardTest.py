...
class CardTester(unittest.TestCase):
    ...
    def testComparison(self):
        ...
        self.assertEqual(card1.compare(card2, hokm_suit=SUITS.NOSUIT, game_mode=game_mode), -1)
        self.assertEqual(card2.compare(card1, hokm_suit=SUITS.NOSUIT, game_mode=game_mode), 1)
